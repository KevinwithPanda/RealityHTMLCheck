...
const PROFILE_TEMPLATES = Object.freeze({
  ...
  product: {
    ...
    privacy: {
      ...
      maxLocalStorageBytes: 262_144,
      maxSessionStorageEntries: 30,
      maxSessionStorageBytes: 131_072,
    },
  ...
  strict: {
    ...
    privacy: {
      ...
      maxLocalStorageBytes: 131_072,
      maxSessionStorageEntries: 20,
      maxSessionStorageBytes: 65_536,
    },
