...
<style>
:root{--ink:#17191f;--muted:#626875;--line:#dedbd3;--paper:#fffdfa;--canvas:#f3f0ea;--accent:#ff5c35;--error:#b42318;--warning:#9a5b05;--advice:#3559a6;font-family:Inter,ui-sans-serif,system-ui,sans-serif;color:var(--ink);background:var(--canvas)}*{box-sizing:border-box}body{margin:0}.wrap{width:min(1100px,calc(100% - 32px));margin:auto}.top{padding:18px 0;color:#fff;background:#191b20}.top .wrap{display:flex;align-items:center;gap:14px}.top b{font-size:18px}.top span{color:#9fa4ae;font-size:11px}.language{display:flex;gap:4px;margin-left:auto}.language button,.filters button,.copy-task,.actions button,.actions a{min-height:40px;border:1px solid #d3cfc7;border-radius:8px;padding:0 12px;background:#fff;color:var(--ink);font:800 11px inherit;cursor:pointer;text-decoration:none;display:inline-flex;align-items:center}.language button{border-color:#444750;background:#23252b;color:#aeb2bc}.language button[aria-pressed=true]{background:#fff;color:#17191f}.hero{padding:58px 0 38px}.eyebrow{margin:0 0 10px;color:var(--accent);font-size:10px;font-weight:900;letter-spacing:.12em}.hero h1{max-width:760px;margin:0;font-size:clamp(38px,7vw,68px);line-height:1;letter-spacing:-.055em}.hero>p:not(.eyebrow){max-width:760px;color:var(--muted);line-height:1.7}.summary{display:grid;grid-template-columns:1.2fr repeat(4,1fr);margin:20px 0 28px;border:1px solid var(--line);border-radius:16px;background:var(--paper);overflow:hidden}.summary div{min-height:108px;display:flex;flex-direction:column;justify-content:center;padding:20px;border-left:1px solid var(--line)}.summary div:first-child{border:0;background:#202127;color:#fff}.summary strong{font-size:36px;letter-spacing:-.05em}.summary span{color:var(--muted);font-size:11px}.summary div:first-child span{color:#b9bdc6}.actions,.filters{display:flex;flex-wrap:wrap;gap:8px;margin-bottom:18px}.actions button:first-child{color:#fff;background:#202127}.filters button[aria-pressed=true]{border-color:#202127;background:#202127;color:#fff}.file-card{margin:18px 0 32px;border:1px solid var(--line);border-radius:16px;background:var(--paper);overflow:hidden}.file-card>header{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:22px 26px;border-bottom:1px solid var(--line)}.file-card header p{margin:0 0 5px;color:var(--muted);font:11px ui-monospace,monospace}.file-card h2{margin:0;font-size:34px}.file-card h2 small{font-size:12px;color:var(--muted)}.file-metrics{display:flex;gap:20px}.file-metrics span{font-weight:900}.file-metrics i{display:block;color:var(--muted);font-size:9px;font-style:normal;font-weight:600}.findings{display:grid;gap:10px;padding:18px}.finding{padding:20px;border:1px solid var(--line);border-radius:12px;background:#fff}.finding[hidden]{display:none}.finding-head{display:flex;align-items:center;gap:8px}.finding-head code{color:var(--muted);font-size:10px}.level,.safe{padding:4px 6px;border-radius:5px;font-size:9px;font-weight:900}.level.error{color:#fff;background:var(--error)}.level.warning{color:#5b3500;background:#ffe6aa}.level.advice{color:#23427f;background:#dfe9ff}.safe{margin-left:auto;color:#17664d;background:#dcf5e9}.finding h3{margin:16px 0 7px;font-size:19px}.finding>p{margin:0;color:var(--muted);line-height:1.6}.remedy{display:grid;gap:5px;margin:15px 0;padding:13px;border-left:3px solid var(--accent);background:#f6f2eb}.remedy b{font-size:10px;text-transform:uppercase}.remedy span{font-size:13px;line-height:1.5}.finding details{margin:12px 0}.finding summary{cursor:pointer;font-size:11px;font-weight:800}.finding ul{padding-left:18px}.finding li{margin:7px 0}.finding li code{display:block;font-size:10px}.finding li span{color:var(--muted);font-size:11px}.copy-task{border:0!important;padding:0!important;border-bottom:1px solid currentColor!important;border-radius:0!important}.clean{padding:24px;color:#17664d}.notice{margin:28px 0;padding:16px;border-radius:10px;color:#534a2e;background:#fff0bd;font-size:12px;line-height:1.6}.toast{position:fixed;right:18px;bottom:18px;opacity:0;padding:10px 13px;border-radius:8px;background:#202127;color:#fff;font-size:11px;transition:.2s}.toast.show{opacity:1}.footer{padding:30px 0 50px;color:var(--muted);font-size:11px}@media(max-width:750px){.summary{grid-template-columns:1fr 1fr}.summary div:first-child{grid-column:1/-1}.summary div:nth-child(even){border-left:0}.file-card>header{align-items:flex-start;flex-direction:column}.file-metrics{width:100%;justify-content:space-between}.safe{margin-left:0}.finding-head{flex-wrap:wrap}}
</style></head><body>
...
<main class="wrap"><section class="hero"><p class="eyebrow">HTML NOTE CHECK</p><h1 data-en="Your note has evidence, not a vague grade." data-zh-cn="笔记问题有证据，不只给模糊评分。">Your note has evidence, not a vague grade.</h1><p data-en="Structure, attachments, internal navigation, portability, safety, mobile readability, and unfinished AI placeholders were checked locally." data-zh-cn="已在本地检查结构、附件、内部导航、可迁移性、安全、手机阅读和未完成的 AI 占位内容。">Structure, attachments, internal navigation, portability, safety, mobile readability, and unfinished AI placeholders were checked locally.</p></section>
...
<div class="actions"><button type="button" id="copy-all" data-task-en="${escapeHtml(allTaskEn)}" data-task-zh-cn="${escapeHtml(allTaskZh)}" data-en="Copy complete repair task" data-zh-cn="复制完整修复任务">Copy complete repair task</button><a href="report.json" download data-en="Download JSON evidence" data-zh-cn="下载 JSON 证据">Download JSON evidence</a><a href="repair-plan.zh-CN.md" download data-en="Download Chinese plan" data-zh-cn="下载中文修复计划">Download Chinese plan</a></div>
...
for(const button of document.querySelectorAll('[data-filter]'))button.addEventListener('click',()=>{const filter=button.dataset.filter;for(const item of document.querySelectorAll('.finding'))item.hidden=filter!=='all'&&item.dataset.level!==filter;for(const item of document.querySelectorAll('[data-filter]'))item.setAttribute('aria-pressed',String(item===button));});
