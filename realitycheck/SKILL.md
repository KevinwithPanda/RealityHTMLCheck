---
name: realitycheck
description: Check, repair, verify, and create evidence-bound passive-static publish packages from local HTML notes or folders, including AI-generated and exported notes; also preview, audit, safely stress-test, fix, and verify a developer-controlled Web app with deterministic real-browser scenarios and before/after proof. Use when Codex receives an HTML note/export, the user asks whether it is correct, portable, shareable, or deployable, local resources are broken, or a localhost or authorized UI needs evidence-first QA and repair.
---
