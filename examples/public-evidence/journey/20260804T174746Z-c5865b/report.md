...
| --- | --- | ---: | --- |
| `baseline` | passed | 619 ms | - |
| `mobile-375` | passed | 655 ms | - |
| `long-text` | passed | 1088 ms | 8 deterministic text mutations were applied. |
| `rtl-arabic` | passed | 1129 ms | Directionality stress test only; translation quality was not assessed. |
| `image-failure` | passed | 735 ms | Expected image request aborts were excluded from failed-request findings. |
| `keyboard-tab` | passed | 1040 ms | No controls were activated or submitted. |
| `journey-settings-notifications` | completed-with-findings | 1328 ms | Stopped safely at step 2; no form was submitted. |
...
- **journey-trace:** {"steps": [{"action": "press", "element": "button", "keyboardInput": "ArrowRight", "passed": true, "role": "tab", "selector": "[role=tab][aria-controls=general]", "step": 1}, {"action": "assert", "assertion": "visible", "count": 0, "passed": false, "reason": "Assertion visible failed for #notifications", "selector": "#notifications", "step": 2, "visibleCount": 0}]}
...
2. 1. press [role=tab][aria-controls=general] ArrowRight.
...
- Started: 2026-08-04T17:47:46.875Z
- Finished: 2026-08-04T17:47:53.585Z
- Duration: 6688 ms
- Tool version: 0.4.0
- Schema version: 1
