...
| --- | --- | ---: | --- |
| `baseline` | completed-with-findings | 712 ms | Baseline runtime findings were recorded. |
| `mobile-375` | passed | 766 ms | Evaluated 375×812; touch-target checks were enabled. |
| `long-text` | passed | 1175 ms | 1 deterministic text mutations were applied. |
| `rtl-arabic` | passed | 1050 ms | Directionality stress test only; translation quality was not assessed. |
| `image-failure` | passed | 694 ms | Expected image request aborts were excluded from failed-request findings. |
| `keyboard-tab` | passed | 752 ms | No controls were activated or submitted. |
...
- **security-posture:** {"examinedCrossOriginResources": 1, "integrityValuesRetained": false, "kinds": {"script": 1}, "missingIntegrity": 1, "origins": ["http://127.0.0.1:4194"], "policy": "subresource-integrity", "resourcePathsRetained": false}
...
- Started: 2026-08-04T22:53:48.240Z
- Finished: 2026-08-04T22:53:53.519Z
- Duration: 5258 ms
- Tool version: 0.4.0
- Schema version: 1
