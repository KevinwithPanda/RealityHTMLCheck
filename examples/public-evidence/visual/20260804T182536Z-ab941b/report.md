...
| --- | --- | ---: | --- |
| `baseline` | completed-with-findings | 826 ms | Baseline runtime findings were recorded. |
| `mobile-375` | passed | 609 ms | - |
| `long-text` | passed | 1285 ms | 7 deterministic text mutations were applied. |
| `rtl-arabic` | passed | 1294 ms | Directionality stress test only; translation quality was not assessed. |
| `image-failure` | passed | 879 ms | Expected image request aborts were excluded from failed-request findings. |
| `keyboard-tab` | passed | 1086 ms | No controls were activated or submitted. |
...
- Started: 2026-08-04T18:25:36.967Z
- Finished: 2026-08-04T18:25:43.064Z
- Duration: 6081 ms
- Tool version: 0.4.0
- Schema version: 1
