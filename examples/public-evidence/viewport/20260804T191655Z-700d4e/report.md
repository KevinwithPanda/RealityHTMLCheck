...
| --- | --- | ---: | --- |
| `baseline` | passed | 641 ms | - |
| `phone-320` | completed-with-findings | 584 ms | Evaluated 320×700; touch-target checks were enabled. |
| `phone-390` | passed | 678 ms | Evaluated 390×844; touch-target checks were enabled. |
| `tablet-768` | passed | 734 ms | Evaluated 768×1024; touch-target checks were enabled. |
| `long-text` | passed | 1157 ms | 3 deterministic text mutations were applied. |
| `rtl-arabic` | passed | 1095 ms | Directionality stress test only; translation quality was not assessed. |
| `image-failure` | passed | 688 ms | Expected image request aborts were excluded from failed-request findings. |
| `keyboard-tab` | passed | 800 ms | No controls were activated or submitted. |
...
- Started: 2026-08-04T19:16:55.984Z
- Finished: 2026-08-04T19:17:02.477Z
- Duration: 6481 ms
- Tool version: 0.4.0
- Schema version: 1
