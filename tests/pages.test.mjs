...
test("GitHub Pages build publishes every live evidence and fixture link", () => {
  ...
  assert.equal(structuredData.softwareVersion, "0.7.0");
  ...
  assert.match(html, /github:KevinwithPanda\/RealityHTMLCheck#v0\.7\.0/);
  ...
  assert.match(llms, /github:KevinwithPanda\/RealityHTMLCheck#v0\.7\.0/);
